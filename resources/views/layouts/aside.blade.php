...
<aside class="app-sidebar">
  ...
  <ul class="app-menu">
    ...
    <li class="treeview @yield('menu-open-ubicacion')"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fas fa-map-marked-alt"></i><span class="app-menu__label">Ubicación</span><i class="treeview-indicator fa fa-angle-right"></i></a>
      <ul class="treeview-menu">
        <li><a class="treeview-item @yield('active-pais')" href="paises"><i class="icon fas fa-globe-americas"></i> País</a></li>
        <li><a class="treeview-item @yield('active-departamento')" href="departamentos"><i class="icon fas fa-location-arrow"></i> Departamento</a></li>
        <li><a class="treeview-item @yield('active-municipio')" href="municipios"><i class="icon fas fa-thumbtack"></i> Municipios</a></li>
      </ul>
    </li>
  </ul>
</aside>
